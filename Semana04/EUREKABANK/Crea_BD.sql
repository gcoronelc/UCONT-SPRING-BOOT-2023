...
BEGIN
	COMMAND := 'DROP USER EUREKABANK CASCADE';
	SELECT COUNT(*) INTO N
	FROM DBA_USERS
	WHERE USERNAME = 'EUREKABANK';
	IF ( N = 1 ) THEN
...
CREATE USER EUREKABANK IDENTIFIED BY admin;

GRANT CONNECT, RESOURCE TO EUREKABANK;

ALTER USER EUREKABANK
QUOTA UNLIMITED ON USERS;

GRANT CREATE VIEW TO EUREKABANK;
